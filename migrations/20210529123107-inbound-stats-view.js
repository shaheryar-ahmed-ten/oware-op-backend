  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.query(`
        ...
        SELECT
          ...
          ProductInwards.quantity AS productInwardQuantity,
          ProductInwards.quantity * Product.weight as weight,
          ProductInwards.quantity * Product.dimensionsCBM as dimensionsCBM,
          UOM.name AS uom,
